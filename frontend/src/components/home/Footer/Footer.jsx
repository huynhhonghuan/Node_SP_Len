...
const Footer = () => {
    return (
        <div className="footer mt-2 d-flex justify-content-between px-5">
            <div className="footer-card">
                ...
                <ul className='list-unstyled mt-4'>
                    <li className='pb-4'><i class="fa-solid fa-phone"></i> Tư vấn dịch vụ: 0343930185</li>
                    <li className='pb-4'><i class="fa-solid fa-phone"></i> Hỗ trợ sử dụng: 0343930185</li>
                    <li className='pb-4'><i class="fa-solid fa-phone"></i> Hỗ trợ vận chuyển: 0343930185</li>
                    <li className='pb-4'><i class="fa-solid fa-envelope"></i> Email: tiemnhalenn88@gmail.com</li>
                    <li className='pb-4'><i class="fa-solid fa-clock"></i> 7:00am – 22:00pm thứ 2 - thứ 7</li>
                </ul>
            </div>
            <div className="footer-card">
                <div className="footer-card-title border-bottom border-secondary border-2 w-100 pb-2">
                ...
                <ul className='list-unstyled mt-4'>
                    <li className='pb-4'><i class="fa-solid fa-chevron-right"></i> Chính sách vận chuyển</li>
                    <li className='pb-4'><i class="fa-solid fa-chevron-right"></i> Điều khoản mua hàng</li>
                    <li className='pb-4'><i class="fa-solid fa-chevron-right"></i> Chính sách đổi trả</li>
                    <li className='pb-4'><i class="fa-solid fa-chevron-right"></i> Bảo mật thông tin</li>
                    <li className='pb-4'>
